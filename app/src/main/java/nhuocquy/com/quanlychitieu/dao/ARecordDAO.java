...
public interface ARecordDAO {
    ...
    List<ARecord> loadByDay(Date date) throws DAOException;
    List<ARecord> loadByWeek(Date date) throws DAOException;
    List<ARecord> loadByMonth(Date date) throws DAOException;
    List<ARecord> loadByYear(Date date) throws DAOException;
    List<ARecord> loadBy2Day(Date from, Date to) throws DAOException;
}
